...
src/kicad-tth: 
  kicad project and fab plots for the pedal, traditional leaded "through the hole" components

src/kicad-smd: 
  kicad project and fab plots for the pedal, surface mount components
